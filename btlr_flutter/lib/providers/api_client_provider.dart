...
/// Activity endpoint provider
final activityEndpointProvider = Provider<EndpointActivity>((ref) {
  final client = ref.watch(clientProvider);
  return client.activity;
});

/// Scraping endpoint provider
final scrapingEndpointProvider = Provider<EndpointScraping>((ref) {
  final client = ref.watch(clientProvider);
  return client.scraping;
});